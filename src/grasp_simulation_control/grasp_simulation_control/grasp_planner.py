...
class GraspPlanner:
    ...
    def _cylindrical_grasp_config(self):
        ...
        # Three fingers wrap
        for i in range(3):
            config[i*4:(i+1)*4] = [0.0, 0.7, 0.8, 0.5]
        # Thumb opposes
        config[12:16] = [1.45, 0, 0.0, 0.0]
        return config
    ...
    def _generate_trajectory(self, start_config, end_config, duration=2.0, dt=0.002):
